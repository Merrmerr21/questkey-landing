  ...
  return (
    <div className="flex min-h-screen bg-muted text-foreground">
      ...
      <aside className="w-64 border-r border-border bg-white flex flex-col hidden md:flex">
        <div className="p-6">
          <Link href="/dashboard" className="flex items-center gap-2 font-display font-bold text-xl tracking-tight text-foreground transition-opacity hover:opacity-80">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden bg-muted">
